...
int main(int argc, char **argv)
{
    ...
    static unsigned char okeymic[16] =  "\xd5\x35\x53\x82\xb8\xa9\xb8\x06\xdc\xaf\x99\xcd\xaf\x56\x4e\xb6";
    ...
    memcpy(sta->wpa.ptk,&optk,80);
    memcpy(sta->wpa.anonce,&oanonce,32);
    sta->wpa.eapol_size=121;
    memcpy(sta->wpa.eapol,&oeapol,256);
    memcpy(sta->wpa.keymic,&okeymic,16);
    memcpy(sta->wpa.snonce,&osnonce,32);
